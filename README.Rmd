...
```{r voom-analysis, eval = FALSE, message=FALSE}
library(FacileData)
...
* We used the [screengif](https://github.com/dergachev/screengif) tool to
  convert screen-capture *.mov files to animated gifs. Thanks 
